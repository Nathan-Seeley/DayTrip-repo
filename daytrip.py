...
def creating_day_trip ():
    user_trip_confirmation_input = input (f"Your day trip is: You are going to {user_destination} on a {user_transportation} to eat at {user_restaurant} and {user_entertainment}. Is this complete? (y/n) ")
    while user_trip_confirmation_input != "y":
        if user_trip_confirmation_input == "no":
        ...
        elif user_trip_confirmation_input == "y":
    ...
    return user_trip_confirmation_input = input (f"Your day trip is: You are going to {user_destination} on a {user_transportation} to eat at {user_restaurant} and {user_entertainment}. Is this complete? (y/n) ")
    
user_day_trip = creating_day_trip ()    
